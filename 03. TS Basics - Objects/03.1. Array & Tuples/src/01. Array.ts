...
// Explicit Array
let thisIsStringArray: string[] = ["Mouse", "Keyboard", "Scissors", "Calculator"];
let thisIsStringNumberArray: (string | number)[] = [5, "Spongebob", 10, "Patrick"];
let thisIsStringNumberArrayAlt: Array<string | number> = [1, "Mr. Crab", 1, "Plankton"];
...
// Tuples in TS
let tupStringNumber: [string, number] = ["Spongebob", 10];
